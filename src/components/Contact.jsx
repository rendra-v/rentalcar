      ...
      <div className="container contact__inner">
        <div className="contact__text">
          ...
          <div className="contact__info">
            ...
            <div className="contact-info-item">
              <div className="contact-info-icon">⏰</div>
              <div>
                <div className="contact-info-label">Waktu Operasi</div>
        ...
        <div className="contact__card">
          ...
          <p className="contact-card__desc">
            Respon pantas! Biasanya balasan dalam <strong>5 minit</strong> semasa waktu operasi.
          </p>
          ...
          <div className="contact-card__note">
            🔒 Perbualan anda selamat &amp; terlindungi
          </div>
        </div>
      </div>
    </section>
