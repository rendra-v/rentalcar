...
const badgeStyles = {
  blue:   { bg: 'rgba(37,99,235,0.12)',   color: '#2563eb', border: 'rgba(37,99,235,0.3)' },
  purple: { bg: 'rgba(167,139,250,0.15)', color: '#7c3aed', border: 'rgba(167,139,250,0.3)' },
  green:  { bg: 'rgba(52,211,153,0.15)',  color: '#059669', border: 'rgba(52,211,153,0.3)' },
  orange: { bg: 'rgba(251,146,60,0.15)',  color: '#ea580c', border: 'rgba(251,146,60,0.3)' },
